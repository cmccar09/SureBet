...
function buildWhyWins(pick) {
  ...
  const PICKS = {
    ...
    'Jordans Cross':          'Anthony Honeyball / William Twiston-Davies · course & distance winner at Cheltenham — Trials Day January 2026 · proven at 2m4f on soft ground · front-runner style ideally suits the stiff Cheltenham finish · knows this track inside out · big-field handicap specialist at exactly the right weight',
    'Gold Dancer':            "Willie Mullins / A. McGuinness · Mullins rarely sends horses to Cheltenham without a serious chance · top weight 152 — highest OR in the race suggesting it's the best horse · 25/1 outstanding each-way value in a 17-runner Grade 2 · amateur rider claim adds intrigue · Mullins targeting Festival handicap with laser precision",
    'Jade De Grugy':          "Willie Mullins / Paul Townend · trained by the world's champion trainer · Mullins/Townend Festival combo statistically unrivalled · Cheltenham specialist over hurdles · switch back from chasing guarantees freshness · tactical pace-setter role available · 11/4 each-way in a deep but winnable Mares Hurdle",
    'Wodhooh':                'François Nicolle / Thomas Beaurain · 2x course & distance winner at Cheltenham over hurdles · proven at this exact venue, trip and discipline — hardest qualification to fake · Grade 3 Leopardstown win · arrived at the Festival in peak condition · form line runs through the best mares in training',
    'Kabral Du Mathan':       'Dan Skelton / Bridget Andrews · course winner at Cheltenham (Relkeel Jan 2026) stepping up to the full Stayers 3-mile trip · Dan Skelton targets this race with forensic planning — runs once to peak here · front-running tactics suit the relentless Cheltenham hill · ⚠️ Today\'s soft/wet ground is a question at 3m — all form wins recorded on Good or Good-Soft · progressive young horse with upside if the step up in trip clicks',
    'Teahupoo':               "Gordon Elliott / J. W. Kennedy · 2x Stayers' Hurdle champion (2023 & 2024) · deliberately skipped 2025 Festival to come back fresh — hungry to reclaim his crown · multiple Grade 1 victories over 3 miles · LOVES soft Cheltenham ground — today's rain and wind plays directly to his strengths · powerful staying style perfectly suited to testing conditions · Kennedy is the Festival's most in-form jockey · rivals cannot match his course & distance record",
    'Jonbon':                 'Nicky Henderson / Nico de Boinville · 2x Arkle Trophy winner at Cheltenham — course specialist over 2m5f · OR 166 — top-rated horse in the Ryanair on a pound-for-pound basis · Grade 1 winner December 2025 on Good ground — career-best form · ⚠️ Today\'s soft/windy conditions are a concern — all recent wins recorded on Good ground · Henderson/de Boinville Festival sharpness is the counter-argument · value at 4/1 if he handles the underfoot conditions',
    'Fact To File':           "Willie Mullins / Paul Townend · back-to-back Ryanair Chase champion (2024 AND 2025) — no horse in history has won three · OR 174 — highest official rating in the race · Irish Gold Cup winner February 2026 — arrived at the Festival in peak condition · Mullins/Townend are the most feared combination over 2m5f at Cheltenham",
    'Ace Of Spades':          'Dan Skelton / Kielan Woods · COURSE WINNER — won the Cheltenham 2m7f qualifier in January 2026 at the Festival track · OR 139, ideally weighted vs the topweight (152) and the field · beat Gowel Road and Lavida Adiva at Huntingdon in January — race fitness confirmed · rain and wind today suits a stamina-backed course specialist · Skelton targeting this with a horse who has done the qualifying homework · 9/1 each-way in a 26-runner field (6 places at 1/5 odds) — outstanding Festival handicap value',

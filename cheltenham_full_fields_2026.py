...
RACE_FULL_FIELDS = {
    ...
    "day1_race6": [
        "Backmersackme", "Newton Tornado", "Wade Out", "One Big Bang", "Grand Geste",
    ],
    "day1_race7": [
        "Jeriko Du Reponet", "Waterford Whispers", "Uhavemeinstitches",
        "Montregard",
    ],  # Sounds Russian removed — not entered for Cheltenham (Betfair confirmed)
    "day2_race1": [

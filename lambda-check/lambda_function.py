...
def fetch_betfair_odds():
    ...
    # Fallback to mock data (always available when real sources fail)
    print("Using mock data for testing (real sources unavailable)")
    now = datetime.datetime.utcnow()
    return [
        {
            "market_id": "1.234567",
            "race_time": (now + datetime.timedelta(minutes=45)).strftime("%Y-%m-%dT%H:%M:%SZ"),
            "course": "Cheltenham",
            "runners": [
                {"name": "Thunder Bolt", "selectionId": 12345, "odds": 5.0},
                {"name": "Speed Demon", "selectionId": 12346, "odds": 3.5},
                {"name": "Lucky Strike", "selectionId": 12347, "odds": 8.0},
            ],
            "timing": {
                "minutes_to_race": 45,
        ...
        {
            "market_id": "1.234568",
            "race_time": (now + datetime.timedelta(hours=2)).strftime("%Y-%m-%dT%H:%M:%SZ"),
            "course": "Ascot",
            "runners": [
                {"name": "Royal Flash", "selectionId": 22345, "odds": 4.2},
                {"name": "Golden Arrow", "selectionId": 22346, "odds": 6.5},
            ],
            "timing": {
                "minutes_to_race": 120,
